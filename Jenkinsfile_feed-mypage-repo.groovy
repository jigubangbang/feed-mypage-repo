pipeline {
        ...
        stage('Deploy Feed-Mypage-Repo Bundle') {
            steps {
                script {
                    ...
                    // feed-mypage-repo의 루트 디렉토리에서 Dockerfile이 존재하므로 dir() 필요 없음
    ...
    post {
        ...
        failure {
            echo "CI/CD Pipeline for feed-mypage-repo failed."
        }
        success {
            echo "CI/CD Pipeline for feed-mypage-repo finished successfully."
        }
    }
}